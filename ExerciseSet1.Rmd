...
**Your Answers here:**
<br> 1. The code is in 'dataSet1R' line 8 -> mytickers = c("SPY", "AAPL"). We can change mytickers to "AAPL" to get the data of Apple.
<br> 2. Apple: Cumulative: 597.3 / Average daily returns: 0.148 / Standard Deviation: 2.389
<br> 3. Yes, you can also add "YHOO" in the code, and then run again. The results for Yahoo are: Cumulative: 290.6 / Average daily returns: 0.072 / Standard Deviation: 3.019
<hr>
<hr>
...
**Your Answers here:**
<br> 1. You can either type `dim(transposedData)` and read 3 4037, which means there is 3 row and 4037 columns (for SPY, AAPL, YHOO), or you can type `ncol(transposedData)` for columns - 4037 and `nrow(transposedData)` for rows -3.
<br> 2. I created a 1:1:1 Portfolio of SPY, AAPL, YHOO - since I already had all three of them in my dataset. Using `portfolio = apply(StockReturns,1,mean)`, you can calculate the mean returns of the three stock.
<br> Then, name the row of the portfolio with the row names from StockReturns, which is dates from 2001-01-03 to 2017-01-20.
<br> Plot the Portfolio with `pnl_plot(portfolio)`
<hr>
<hr>
...
**Your Answers here:**
<br> 1. We change the start date to "2000-12-29" on line 9 in dataSet1.R, which was the last working day of year 2000 - This gives us data starting from 2001-01-02, the first working day of the year.
<br> 2. Did this above, by adding data from YHOO, and creating a equally weighted portfolio for three companies.
<hr>
<hr>
...
**Your Answers here:**
<br> 1. It gives me the sum of the 20 rows of data in Mydata
<hr>
<hr>
