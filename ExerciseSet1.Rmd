...
<br> 3. Yes, you can change "AAPL" to "YHOO" in the code, and then run again. The results for Yahoo are: Cumulative: 290.6 / Average daily returns: 0.072 / Standard Deviation: 3.019
<br>
...
**Your Answers here:**
<br> 1. You can either type View(transposedData) and read num[1, 1:4034], which means there is 1 row and 4034 columns (for YHOO data), or you can type ncol(transposedData) for columns, and nrow(transposedData) for rows, which is also 4034, and 1.
<br>
<br>
<br>
...
**Your Answers here:**
<br> 1. We change the start date to "2000-12-29" on line 9 in dataSet1.R, which was the last working day of year 2000.
<br>
<br>
<br>
...
**Your Answers here:**
<br>1. It gives me the answer 60
<br>
<br>
<br>
